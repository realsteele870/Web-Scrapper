...
def webScrape(searchItem):
    ...
    for item_element in item_elements:
        if flag == 0:
            ...
            print(title_element+" "+price_element+" source pos: "+str(title_elementCheck.sourcepos)+" few pos: "+str(fewpos))

            if is_number(realprice) and ignore ==1 and (title_elementCheck.sourcepos < fewpos or fewpos == 0):
